...
void backgroundtree()
{
	...
	glBegin(GL_POLYGON);
	glColor3ub(129, 132, 138);
	glVertex2f(-1.0f, 0.45f);
    glVertex2f(-0.8f, 0.75f);///11
...
void grass1()
{
    ...
    glVertex2f(e, f); // center of circle
    for(i = 0; i <= triangleAmount;i++) {
        glVertex2f(e + (radius11 * cos(i *  twicePi / triangleAmount)),f+ (radius11 * sin(i * twicePi / triangleAmount)));
    }
	glEnd();
    ...
    glVertex2f(g, h); // center of circle
    for(i = 0; i <= triangleAmount;i++) {
        glVertex2f(g + (radius11 * cos(i *  twicePi / triangleAmount)),h+ (radius11 * sin(i * twicePi / triangleAmount)));
    }
	glEnd();
    ...
    for(i = 0; i <= triangleAmount;i++) {
        glVertex2f(a1+(radius11 *cos(i * twicePi / triangleAmount)),b1 + (radius11 * sin(i * twicePi / triangleAmount)));
    }
	glEnd();
	glLoadIdentity();
}
...
{
    char text[120];
    sprintf(text, "American International University Bangladesh",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -40 , 50 );
    ...
    sprintf(text, "Spring 2022-2023",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -20 , 45 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text, "Computer Graphics (D)",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -25 , 40 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text, "Final Project",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -17 , 35 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text, "VOLCANO MOUNTAIN WITH VILLAGE SCENARIO",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -52 , 30 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text, "Submitted to : Mahfujur Rahman",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -30 , 25 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"  PRESS D FOR DAY VIEW , N FOR NIGHT VIEW, R FOR RAIN , F FOR FIRE",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -55 ,15 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    for(int i = 0; text[i] != '\0'; i++)
    {
        ...
        else glutBitmapCharacter(GLUT_BITMAP_9_BY_15, text[i]);
    }

    sprintf(text,"  ABDULLAH AL MAMAUN (20-43562-1)",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -30 , 5 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"  EFTAKHARUL ISLAM EMON (20-43555-1)",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -30 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"  ABDUL MALEK RONY (20-43687-2)",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -30 , -5 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"  A.S.M FAHAD HASAN (20-42931-1)",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -30 , -10);
    for(int i = 0; text[i] != '\0'; i++)
    {
	...
	switch (key) {
	   case 'f':
        ...
        case 'r':
            ...
            PlaySound(TEXT("rain-02.wav"), NULL, SND_ASYNC);
            break;
        ...
        case  'D':
            ...
            glutKeyboardFunc(handleKeypress);
            glutDisplayFunc(display);
            PlaySound(TEXT("bird-2.wav"), NULL, SND_ASYNC|SND_FILENAME);
            break;
            //break;
        case 'R':
            glutDestroyWindow(1);
